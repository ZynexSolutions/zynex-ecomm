...
export function CustomPricing() {
    ...
    return (
        ...
        <div className="pricing sp">
            <div className="container">{/* Replaces container */}
                {/* Optional: Heading section if needed outside the card */}

                <div className="row">
                    <div className="col-lg-8 m-auto text-center">
                        <div className="heading4">
                            <span className="span" data-aos="zoom-in-left" data-aos-duration="700">Pricing 👋</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="custom-pricing-card">
                        <div className="custom-pricing-grid">
                            ...
                            <div className="custom-pricing-left-col">
                                <div className='custom-pricing-left-col-top'> {/* Top group: Heading + Sliders */}
                                ...
                                <div className="custom-pricing-savings-area">
                                    <span className="custom-pricing-savings-percentage">{savingsPercentage}%</span>
